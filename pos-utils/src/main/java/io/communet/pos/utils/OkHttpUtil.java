...
public class OkHttpUtil {
    ...
    public static String postForm(String url,Map<String,String> params,Headers headers){
        ...
        Request request = new Request.Builder()
                ...
                .headers(headers)
                .build();
        return postForm(params,request);
    }
    ...
    public static String postForm(Map<String,String> params,Request request){
        logger.info("OkHttpUtil.postForm url : " + request.url().toString());
        MultipartBody.Builder builder=  new MultipartBody.Builder().setType(MultipartBody.FORM);
        for (String key : params.keySet()) {
            builder.addFormDataPart(key, params.get(key));
        }
